  ...
  return (
    <>
      ...
      >
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
          <div className="flex items-center justify-between h-16">
            ...
            {/* NAV LINKS */}
            <div className="hidden lg:flex items-center gap-3 xl:gap-5 ml-4 xl:ml-6 min-w-0">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  to={link.href}
            ...
            <div className="hidden lg:flex items-center shrink-0 ml-3 xl:ml-4">
              ...
              <div className="ml-3 xl:ml-4">
                <Button
                  variant="gold"
                  className="h-10 px-4 xl:px-5 shrink-0 flex items-center rounded-lg text-sm font-semibold whitespace-nowrap shadow-md hover:shadow-yellow-500/20 transition"
                  asChild
                >
